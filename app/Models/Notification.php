    ...
    public function toHtml()
    {
        ...
        if(!empty($usr))
        {
            ...
            if($this->type == 'assign_lead')
            {
                ...
                $text       = $usr->name . " " . __('Added you') . " " . __('in lead') . " <b class='font-weight-bold'>" . (isset($data->name) ? $data->name : __('Unnamed')) . "</b> ";
                $icon       = "fa fa-plus";
                $icon_color = 'bg-primary';
            }
            ...
            if($this->type == 'termination')
            {
                ...
                $text       = (isset($data->name) ? $data->name : __('Unnamed')) . " " . @$this->notification_for . " <b class='font-weight-bold'>" . $usr->name . "</b> ";
                $icon       = "fa fa-eye";
                $icon_color = 'bg-primary';
            }
            ...
            if($this->type == 'resignation')
            {
                ...
                $text       = (isset($data->name) ? $data->name : __('Unnamed')) . " " . @$this->notification_for;
                $icon       = "fa fa-eye";
                $icon_color = 'bg-primary';
            }
            ...
            if($this->type == 'promotion')
            {
                ...
                $text       = (isset($data->name) ? $data->name : __('Unnamed')) . " " . @$this->notification_for . (isset($data->promotion) ? $data->promotion : '') . " <b class='font-weight-bold'>by " . $usr->name . "</b> ";
                $icon       = "fa fa-eye";
                $icon_color = 'bg-primary';
            }
            if($this->type == 'award')
