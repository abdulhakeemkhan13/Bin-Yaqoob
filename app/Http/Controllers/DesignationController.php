...
class DesignationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(\Auth::user()->can('create designation'))
        {
            ...
            $html = view('designation.appendrow', ['designations' => [$designation]])->render();
            $data = [
                'datarow' => $html,
                'table_id' => "designation-table",
                'action' => 'add',
                'row_id' => $designation->id,
            ];
            return response()->json(['success' => true, 'message' => __('Designation  successfully created.'), 'data' => $data]);
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
    ...
    public function update(Request $request, Designation $designation)
    {
        ...
        if(\Auth::user()->can('edit designation'))
        {
            if($designation->created_by == \Auth::user()->creatorId())
            {
                ...
                return response()->json(['success' => true, 'message' => __('Designation successfully updated.'), 'data' => $data]);
            }
            else
            {
                return redirect()->back()->with('error', __('Permission denied.'));
