...
class AssignTargetController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            \DB::commit();
            $html = view('assign_target.appendrow', compact('target'))->render();
            $data = [
                'datarow' => $html,
            ...
            return response()->json(['success' => true, 'message' => __('Target successfully created.'), 'data' => $data]);
        } catch (\Exception $e) {
            \DB::rollBack();
            dd($e);
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            return response()->json(['success' => true, 'message' => __('Target successfully updated.'), 'data' => $data]);
        } catch (\Exception $e) {
            \DB::rollBack();
            dd($e);
            return response()->json(['error' => $e->getMessage()], 400);
