...
class IndicatorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            if (\Auth::user()->can('create indicator')) {
                ...
                \DB::commit();
                $html = view('indicator.appendrow', compact('indicator'))->render();
                $data = [
                    'datarow' => $html,
                    'table_id' => "indicator-table",
                ];
                return response()->json(['success' => true, 'message' => __('Indicator successfully created.'), "data" => $data, 200]);
    ...
    public function update(Request $request, Indicator $indicator)
    {
        ...
        if (\Auth::user()->can('edit indicator')) {
            ...
            return response()->json(['success' => true, 'message' => __('Indicator successfully updated.'), 'data' => $data]);
