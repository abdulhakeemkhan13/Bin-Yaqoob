...
class RevenueController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(\Auth::user()->can('create revenue'))
        {
            ...
            if($webhook)
            {
                ...
                {
                    return response()->json(['error' => __('Webhook call failed.')], 401);
                }
            }
            ...
            $html = view('revenue.appendrow', compact('revenue'))->render();
            $data = [
                'datarow' => $html,
            ...
            return response()->json(['success' => true, 'message' => __('Revenue successfully created.'), 'data' => $data]);
    ...
    public function update(Request $request, Revenue $revenue)
    {
        ...
        if(\Auth::user()->can('edit revenue'))
        {
            ...
            return response()->json(['success' => true, 'message' => __('Revenue Updated Successfully.'), 'data' => $data]);
