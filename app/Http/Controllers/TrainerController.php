...
class TrainerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(\Auth::user()->can('create trainer'))
        {
            ...
            $html = view('trainer.appendrow', compact('trainer'))->render();
            $data = [
                'datarow' => $html,
                'table_id' => "trainer-table",
            ];
            return response()->json(['success' => true, 'message' => __('Trainer successfully created.'), 'data' => $data]);
    ...
    public function update(Request $request, Trainer $trainer)
    {
        if(\Auth::user()->can('edit trainer'))
        {
            ...
            return response()->json(['success' => true, 'message' => __('Trainer successfully updated.'), 'data' => $data]);
