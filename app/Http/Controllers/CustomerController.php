...
class CustomerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(\Auth::user()->can('create customer'))
        {
            ...
            \DB::commit();
            if($request->ajax()) {
                $html = view('customer.appendrow', compact('customer'))->render();
                $data = [
                    'datarow' => $html,
                ...
                return response()->json(['success' => true, 'message' => __('Customer successfully created.'), 'data' => $data]);
            }
    ...
    public function update(Request $request, Customer $customer)
    {
        ...
        if(\Auth::user()->can('edit customer'))
        {
            ...
            if($request->ajax()) {
                ...
                return response()->json(['success' => true, 'message' => __('Customer successfully updated.'), 'data' => $data]);
            }
