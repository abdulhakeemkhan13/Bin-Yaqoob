...
use App\Http\Controllers\RemindersTypeController;
...
use App\Http\Controllers\MinutesSheetController;
use App\Http\Controllers\MinutesSheetCheckController;
...
// Salary Tax
Route::get('salarytaxs/create/{employee}', [SalaryTaxController::class, 'salarytaxCreate'])
    ->name('salarytaxs.create');

Route::post('salarytaxs', [SalaryTaxController::class, 'store'])
    ->name('salarytaxs.store');

Route::get('salarytax/{salarytax}/edit', [SalaryTaxController::class, 'edit'])
    ->name('salarytax.edit');

Route::put('salarytax/{salarytax}', [SalaryTaxController::class, 'update'])
    ->name('salarytax.update');
...
Route::post('eobis', [EobiController::class, 'store'])->name('eobis.store');
Route::get('eobi/{id}/edit', [EobiController::class, 'edit'])->name('eobi.edit');
Route::put('eobi/{id}', [EobiController::class, 'update'])->name('eobi.update');
Route::delete('eobi/{id}', [EobiController::class, 'destroy'])->name('eobi.destroy');

// increment
Route::middleware(['auth', 'XSS'])->group(function () {
Route::get('employee/increment/form', [EmployeeController::class, 'incrementForm'])->name('employee.increment.form');
Route::get('employee/increment/info/{id}', [EmployeeController::class, 'incrementInfo'])->name('employee.increment.info')->middleware(['auth', 'XSS']);
Route::post('employee/increment', [EmployeeController::class, 'employeeIncrement'])->name('employee.increment');
Route::get('employee/increment/history/{id}', [EmployeeController::class, 'incrementHistory'])->name('employee.increment.history');
});
...
Route::post('user-login/{id}', [UserController::class, 'LoginManage'])->name('users.login');
...
Route::group(['middleware' => ['verified']], function () {
    ...
    // Cheque CRUD Routes
    Route::prefix('cheque')->name('cheque.')->group(function () {

        // Display list of cheques with filters
        Route::get('/', [App\Http\Controllers\ChequeController::class, 'index'])
            ->name('index');

        // Show create form
        Route::get('/create', [App\Http\Controllers\ChequeController::class, 'create'])
            ->name('create');
        ...
        // Show single cheque details
        Route::get('/{id}', [App\Http\Controllers\ChequeController::class, 'show'])
            ->name('show');

        // Show edit form
        Route::get('/{id}/edit', [App\Http\Controllers\ChequeController::class, 'edit'])
            ->name('edit');

        // Update cheque
        Route::put('/{id}', [App\Http\Controllers\ChequeController::class, 'update'])
            ->name('update');

        // Delete cheque
        Route::delete('/{id}', [App\Http\Controllers\ChequeController::class, 'destroy'])
            ->name('destroy');

        Route::post('/approve', [App\Http\Controllers\ChequeController::class, 'approve'])
            ->name('approve');

        // Print cheque as Minute Sheet
        Route::get('/{id}/print', [App\Http\Controllers\ChequeController::class, 'print'])
            ->name('print');
        
    });

    Route::get('/report/cheque-list', [App\Http\Controllers\ChequeController::class, 'index'])
        ->name('report.cheque.list');
    ...
    Route::group(['middleware' => ['auth', 'XSS', 'revalidate']], function () {
        Route::resource('reminders', RemindersController::class);        // index/create/store/show/edit/update/destroy
        Route::resource('reminder-types', \App\Http\Controllers\ReminderTypeController::class); // index/create/store/show/edit/update/destroy
    });
    ...
    Route::group(
        ...
        function () {
            Route::resource('minutes-sheet', MinutesSheetController::class);
            Route::get('minutes-sheet/{id}/action', [MinutesSheetController::class, 'action'])->name('minutes-sheet.action');
            Route::post('minutes-sheet/process-action', [MinutesSheetController::class, 'processAction'])->name('minutes-sheet.process-action');
            Route::get('minutes-sheet/{id}/print', [MinutesSheetController::class, 'print'])->name('minutes-sheet.print');
            
            // Minutes Sheet Checks
            Route::get('minutes-sheet/{id}/check/create', [MinutesSheetCheckController::class, 'create'])->name('minutes-sheet.check.create');
            Route::post('minutes-sheet/check/store', [MinutesSheetCheckController::class, 'store'])->name('minutes-sheet.check.store');
            Route::post('minutes-sheet/check/{id}/approve', [MinutesSheetCheckController::class, 'approve'])->name('minutes-sheet.check.approve');
            Route::delete('minutes-sheet/check/{id}', [MinutesSheetCheckController::class, 'destroy'])->name('minutes-sheet.check.destroy');
        }
    );
    ...
    Route::group(
        ...
        function () {
            ...
            Route::delete('invoice/{id}/payment/{pid}/destroy', [InvoiceController::class, 'paymentDestroy']);
    ...
    Route::group(
        ...
        function () {
            ...
            Route::delete('bill/{id}/payment/{pid}/destroy', [BillController::class, 'paymentDestroy']);
    ...
    Route::group(
        ...
        function () {
            ...
            // Route::get('report/cheque-list-report', [ReportController::class, 'chequeListReport'])->name('report.cheque.list');
