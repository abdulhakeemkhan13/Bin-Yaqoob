                            ...
                            <div class="card-body employee-detail-create-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6" id="deployed_at_wrap" style="display:none;">
                                        ...
                                        {!! Form::text('deployed_at', old('deployed_at'), [
                                            'class' => 'form-control',
                                    ...
                                    <div class="form-group col-md-6" id="deployed_date_wrap" style="display:none;">
                                        ...
                                        {!! Form::date('deployed_date', old('deployed_date'), [
                                            'class' => 'form-control',
                                            'autocomplete' => 'off',
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function isGuardSelected() {
        // Check visible text (handles typos like "gaurd" too)
        const text = (designationSelect.options[designationSelect.selectedIndex]?.text || '')
            .trim().toLowerCase();
        return text.includes('guard') || text.includes('gaurd'); // tolerate misspelling
    }
    ...
    toggleDeployedFields(); // initialize on page load
});
</script>
    <script>
