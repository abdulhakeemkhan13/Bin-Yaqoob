{{ Form::open(['url' => 'customer', 'method' => 'post', 'data-ajax' => 'true', 'id' => 'customer-form']) }}
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                {{ Form::text('father_or_spouse_name', null, ['class' => 'form-control', 'placeholder' => __('Enter Father/Spouse Name')]) }}
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                {{ Form::text('cnic_number', null, ['class' => 'form-control', 'placeholder' => __('Enter CNIC Number')]) }}
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                {{ Form::label('mobile_primary', __('Mobile Primary'), ['class' => 'form-label']) }}
                {{ Form::text('mobile_primary', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Enter Primary Mobile')]) }}
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                {{ Form::label('mobile_secondary', __('Mobile Secondary'), ['class' => 'form-label']) }}
                {{ Form::text('mobile_secondary', null, ['class' => 'form-control', 'placeholder' => __('Enter Secondary Mobile')]) }}
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::textarea('current_address', null, ['class' => 'form-control', 'rows' => 2, 'placeholder' => __('Enter Current Address')]) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('permanent_address', __('Permanent Address'), ['class' => 'form-label']) }}
                {{ Form::textarea('permanent_address', null, ['class' => 'form-control', 'rows' => 2, 'placeholder' => __('Enter Permanent Address')]) }}
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::textarea('billing_address', null, ['class' => 'form-control', 'rows' => 2, 'placeholder' => __('Enter Address')]) }}
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {{ Form::textarea('shipping_address', null, ['class' => 'form-control', 'rows' => 2, 'placeholder' => __('Enter Address')]) }}
