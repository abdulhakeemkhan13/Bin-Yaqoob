...
@section('content')
        ...
        <div class="container-kanban">
            ...
            <div class="row kanban-wrapper horizontal-scroll-cards" data-plugin="dragula" data-containers='{!! json_encode($json) !!}'>
                @foreach($stages as $stage)
                    ...
                    <div class="col" data-row_id="{{$stage->id}}" task-list="task-list-{{$stage->id}}">
                        <div class="card" data-row_id="{{$stage->id}}">
                            ...
                            <div class="card-body kanban-box" id="task-list-{{$stage->id}}" data-id="{{$stage->id}}"
                                data-id="{{$stage->id}}" data-card-container="task-list-{{$stage->id}}">
    ...
    {!! Form::open([
        ...
        <button type="button"
                ...
                data-form="delete-form-{{ $application->id }}"
...
@push('script-page')
    ...
    <script>
        // Pretty confirm handler (matches your screenshot feel)
