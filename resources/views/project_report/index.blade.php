                        ...
                        @if(isset($projects) && !empty($projects) && count($projects) > 0)
                            @foreach ($projects as $key => $project)
                                <tr>
                                    ...
                                    <td class="">
                                        <span class="badge bg-{{ isset(\App\Models\Project::$status_color[$project->status]) ? \App\Models\Project::$status_color[$project->status] : 'secondary' }} p-2 px-3 rounded status_badge">{{ isset(\App\Models\Project::$project_status[$project->status]) ? __(\App\Models\Project::$project_status[$project->status]) : __('Unknown') }}</span>
                                    </td>
                                    <td class="">
                                        @can('manage project')
