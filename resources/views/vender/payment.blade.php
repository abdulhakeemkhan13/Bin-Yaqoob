                ...
                <div class="card-body table-border-style">
                    <div class="row d-flex justify-content-end mt-2">
                        ...
                        <div class="col-auto my-auto">
                            <a href="#" class="apply-btn report-action-btn" data-action="apply" data-form="frm_submit" data-toggle="tooltip" data-original-title="{{__('apply')}}">
                                <span class="btn-inner--icon"><i class="ti ti-search"></i></span>
                            </a>
                            <a href="#" class="reset-btn report-action-btn" data-action="reset" data-form="frm_submit" data-reset-url="{{route('vender.payment')}}" data-toggle="tooltip" data-original-title="{{__('Reset')}}">
