...
<div class="row">
        ...
        <div class="mt-2 " id="multiCollapseExample1">
            <div class="card">
                <div class="card-body" style="padding-top: 12px;">
                    {{ Form::open(['route' => ['deals.index'], 'method' => 'GET', 'id' => 'customer_submit']) }}
                    <div class="row d-flex align-items-center justify-content-end">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                            <div class="btn-box">
                                ...
                                <select class="select form-control form-select"  multiple="multiple" name="labels[]" id="label">
                                    @foreach ($labels as $label)
                                        <option value="{{ $label->id }}" {{ in_array($label->id, $selectedLabels) ? 'selected' : '' }}>
                                            {{ $label->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                            <div class="btn-box">
                                ...
                                <input type="search" name="search" class="form-control" id="search" value="{{ isset($_GET['search'])?$_GET['search']:''}}" placeholder="Search from name,phone,price">
                            </div>
                        </div>
                        <div class="col-auto float-end ms-2 mt-4">
                            ...
                            <a href="{{ route('deals.index') }}" class="btn btn-sm btn-danger" data-toggle="tooltip"
    ...
    <div class="row">
        ...
        <div class="row kanban-wrapper horizontal-scroll-cards" data-containers='{!! json_encode($json) !!}' data-plugin="dragula">
            ...
            @php($deals = $stage->search($query,$pipeline->id,$stage->id))
                <div class="col" data-row_id="{{$stage->id}}" task-list="{{$stage->id}}">
                    <div class="card" data-row_id="{{ $stage->id }}">
                        ...
                        <div class="card-body kanban-box" id="task-list-{{$stage->id}}" data-id="{{$stage->id}}" data-card-container="task-list-{{$stage->id}}"
