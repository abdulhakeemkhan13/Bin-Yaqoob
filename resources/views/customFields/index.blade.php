            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="mt-2 " id="multiCollapseExample1">
                        <div class="card">
                            <div class="card-body" style="padding-top: 6px; padding-bottom: 12px;">
                                {{ Form::open(['route' => ['custom-field.index'], 'method' => 'GET', 'id' => 'customer_submit']) }}
                                <div class="row d-flex align-items-center justify-content-end">

                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                        <div class="btn-box">
                                            {{ Form::label('module', __('Module'),['class'=>'form-label']) }}
                                            {{ Form::select('module',$modules,null, array('class' => 'form-control select')) }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-auto float-end ms-2 mt-4">
                                        ...
                                        <a href="{{ route('custom-field.index') }}" class="btn btn-sm btn-danger" data-toggle="tooltip"
            ...
            <div class="card">
                <div class="card-body table-border-style">
                    <div class="table-responsive">
                        <table class="table datatable" id="custom-field-table">
                            <thead>
                            <tr>
