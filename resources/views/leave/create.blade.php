{{Form::open(array('url'=>'leave','method'=>'post', 'data-ajax'=>'true', 'id'=>'leave-form', 'data-type'=>'leave'))}}
    <div class="modal-body">
        ...
        @endif
        {{-- end for ai module--}}
        @if(\Auth::user()->type =='company' || \Auth::user()->type =='HR' || \Auth::user()->type =='branch' || @$type == 'report')
            <div class="row">
                <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {{Form::textarea('leave_reason',null,array('class'=>'form-control','placeholder'=>__('Leave Reason'),'required' =>'required','rows'=>'3'))}}
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {{Form::textarea('remark',null,array('class'=>'form-control grammer_textarea','placeholder'=>__('Leave Remark'),'required' =>'required','rows'=>'3'))}}
                </div>
            </div>
    ...
    <div class="modal-footer">
        ...
        <input type="submit" value="{{__('Create')}}" class="btn btn-primary" id="submit-leave">
    </div>
{{Form::close()}}