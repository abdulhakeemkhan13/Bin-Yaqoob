...
@section('content')
    <div class="row">
        {{-- ajax enabled --}}
        {{ Form::model($proposal, array('route' => array('proposal.update', $proposal->id), 'method' => 'PUT','class'=>'w-100','data-ajax'=>'true', 'id'=>'proposal-form')) }}
        <div class="col-12">
        ...
        <div class="col-12">
            ...
            <div class="card repeater" data-value='{!! json_encode($proposal->items) !!}'>
                ...
                <div class="card-body table-border-style">
                    <div class="table-responsive" id="sortable-table-wrapper">
                        <table class="table mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tbody class="ui-sortable" data-repeater-item id="sortable-table-body">
