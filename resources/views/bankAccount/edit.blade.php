{{ Form::model($bankAccount, array('route' => array('bank-account.update', $bankAccount->id), 'method' => 'PUT', 'data-ajax'=>'true', 'id'=>'bank-account-form')) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group  col-md-6">
            ...
            {{ Form::number('opening_balance',null, array('class' => 'form-control','step'=>'0.01','readonly'=>'readonly')) }}
        </div>
        <div class="form-group  col-md-6">
