...
@section('content')
    <div class="row">
        <div class="col-xxl-12">
            <div class="row" data-card-container="user-cards">
                                            ...
                                            @if ($user->is_active == 1 && $user->is_disable == 1)
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    @if ($user->is_enable_login == 1)
                                                        <a href="javascript:void(0)" data-url="{{ route('users.login', \Crypt::encrypt($user->id)) }}" data-ajax-login="true" class="dropdown-item">
