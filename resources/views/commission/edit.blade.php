...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6" id="employee_div">
            ...
            {{ Form::select('employee_id', ['' => __('Select Employee')] + $employees->toArray(), null, ['class' => 'form-control select']) }}
        </div>
        ...
        <div class="form-group col-md-6 d-none" id="management_div">
            ...
            {{ Form::select('user_id', ['' => __('Select User')] + $users->toArray(), $commission->dealer_id, ['class' => 'form-control select']) }}
        </div>

        <div class="form-group col-md-6">
            {{ Form::label('contract_id', __('Contract'), ['class' => 'form-label']) }}
            {{ Form::select('contract_id', ['' => __('Select Contract')] + $contracts->toArray(), null, ['class' => 'form-control select']) }}
        </div>

        <div class="form-group col-md-6">
            {{ Form::label('deal_id', __('Deal'), ['class' => 'form-label']) }}
            {{ Form::select('deal_id', ['' => __('Select Deal')] + $deals->toArray(), null, ['class' => 'form-control select']) }}
        </div>
