...
{{-- {{ Form::model($client, array('route' => array('clients.update', $client->id), 'method' => 'PUT', 'data-ajax'=>'true', 'id'=>'client-form')) }} --}}
{{Form::open(array('url'=>'clients.update','method'=>'post', 'data-ajax'=>'true', 'id'=>'client-form'))}}
