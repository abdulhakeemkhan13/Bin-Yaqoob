...
@endphp
<style>
    /* Tweakable row height */
    .upcoming-deadlines-scroll {
        --deadline-row-h: 84px;
        /* adjust if your rows are taller/shorter */
        max-height: calc(var(--deadline-row-h) * 4 + 8px);
        /* ≈ 4 rows visible */
        overflow-y: auto;
    ...
    .upcoming-deadlines-scroll:hover {
        scrollbar-width: thin;
    }

    /* Firefox */

    .upcoming-deadlines-scroll::-webkit-scrollbar {
        width: 0;
        height: 0;
    }

    /* hidden */
    .upcoming-deadlines-scroll:hover::-webkit-scrollbar {
        width: 8px;
        height: 8px;
    }

    /* show on hover */
    .upcoming-deadlines-scroll::-webkit-scrollbar-thumb {
        background-color: rgba(0, 0, 0, .25);
        border-radius: 8px;
    }

    .upcoming-deadlines-scroll::-webkit-scrollbar-track {
        background: transparent;
    }

    /* Each list item ≈ one row */
    .deadline-item {
        min-height: var(--deadline-row-h);
        display: flex;
        align-items: center;
                        ...
                        <div class="row " style="display: contents;">
                            ...
                            <div class="col-xl-6 col-xxl-6 ">
                                <div class="card " style ="height: 95%;">
                                    <div class="card-header">
                                        {{-- for reminders of events: upcoming events --}}
                                        <h5 class="mt-1 mb-0">{{ __('Upcoming Deadlines') }}</h5>
                                    </div>
                                    <div class="card-body p-3 upcoming-deadlines-scroll">
                                        <div class="row">
                                            @forelse($upcomingDeadlines as $r)
                                                @php
                                                    $days = \Carbon\Carbon::today()->diffInDays($r->due_date, false);
                                                    if ($days === 0) {
                                                        $badge = 'warning';
                                                        $statusText = __('Due Today');
                                                    } elseif ($days <= $r->before_days) {
                                                        $badge = 'warning';
                                                        $statusText = __('Due in :n day(s)', ['n' => $days]);
                                                    } else {
                                                        $badge = 'secondary';
                                                        $statusText = __('Due in :n day(s)', ['n' => $days]);
                                                    }
                                                @endphp
                                                <div class="col-sm-12 my-2 border-b deadline-item">
                                                    <div
                                                        class="d-flex align-items-start justify-content-between mb-2 margin_inline w-100">
                                                        <div class="d-flex">
                                                            <div class="theme-avtar bg-primary">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="text-primary text-sm mb-0">
                                                                    {{ $r->type?->name ?? __('General') }}</p>
                                                                <a href="#"
                                                                    class="mb-0 fw-semibold text-decoration-none"
                                                                ...
                                                                <div class="text-muted small">
                                                                    {{ __('Remind from') }}:
                                                                    {{ $r->remind_from_date->format('Y-m-d') }} &middot;
                                                                    {{ __('Due') }}:
                                                                    <strong>{{ $r->due_date->format('Y-m-d') }}</strong>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="text-end">
                                                            <span
                                                                class="badge bg-{{ $badge }}">{{ $statusText }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            @empty
                                            ...
                                            <div class="col-sm-12 my-2 border-b">
                                                <div
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="theme-avtar bg-primary">
                                                            <img class="image-icon"
                                                                src="{{ asset('/assets/images/2.1.png') }}"
                                                                alt="">
                                                            {{-- <i class="ti ti-report-money"></i> --}}
                                                        </div>
                                                        <div class="ms-2">
                                            ...
                                            <div class="col-sm-12 my-2 border-b">
                                                <div
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="theme-avtar bg-primary">
                                                            <img class="image-icon"
                                                                src="{{ asset('/assets/images/2.2.png') }}"
                                                                alt="">
                                            ...
                                            <div class="col-sm-12 my-2 border-b">
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="theme-avtar bg-primary">
                                                            <img class="image-icon"
                                                                src="{{ asset('/assets/images/2.3.png') }}"
                                                                alt="">
                                                            {{-- <i class="ti ti-report-money"></i> --}}
                                                        </div>
                                                        <div class="ms-2">
                                ...
                                <div class="card-header d-flex justify-content-between">
                                    <h5 id="chart-title">{{ __('Income By Category') }}
                                        <span class="float-end text-muted"
                                            style="margin-left: 15px">{{ __('Year') . ' - ' . $currentYear }}</span>
                                    </h5>
                                    <div>
