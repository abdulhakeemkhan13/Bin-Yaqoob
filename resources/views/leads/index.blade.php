        ...
        <div class="col-sm-12">
            ...
            <div class="row kanban-wrapper horizontal-scroll-cards" data-containers='{!! json_encode($json) !!}'
                ...
                @foreach ($lead_stages as $lead_stage)
                    ...
                    <div class="col" data-row_id="{{ $lead_stage->id }}" task-list="{{ $lead_stage->id }}">
                        <div class="card" data-row_id="{{ $lead_stage->id }}">
                            ...
                            <div class="card-body kanban-box" id="task-list-{{ $lead_stage->id }}"
                                data-id="{{ $lead_stage->id }}" data-card-container="task-list-{{ $lead_stage->id }}"
                                data-status="{{ $lead_stage->name }}">
