{{Form::model($warning,array('route' => array('warning.update', $warning->id), 'method' => 'PUT', 'data-ajax'=>'true', 'id'=>'warning-form')) }}
{{-- {{Form::open(array('url'=>'warning','method'=>'post', 'data-ajax'=>'true', 'id'=>'warning-form'))}} --}}
