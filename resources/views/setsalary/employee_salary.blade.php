                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    @can('create other payment')
                                        <div class="col text-end">
                                            <a href="#" data-url="{{ route('salarytaxs.create', $employee->id) }}"
                                                data-size="lg" data-ajax-popup="true" data-title="{{ __('Create Tax') }}"
                                                data-bs-toggle="tooltip" title="{{ __('Create') }}"
                                                data-original-title="{{ __('Create Tax') }}"
                                                class="apply-btn btn btn-sm btn-primary">
                                                <i class="ti ti-plus"></i>
                                            </a>
                                        </div>
                                ...
                                <div class="table-responsive">
                                    @if (!$salarytax->isEmpty())
                                        <table class="table table-striped mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($salarytax as $salarytax)
                                                    <tr>
                                                        <td>{{ !empty($salarytax->employee()) ? $salarytax->employee()->name : '' }}
                                                        </td>
                                                        <td>{{ $salarytax->title }}</td>
                                                        <td>{{ $salarytax->amount }} (${{ $salarytax->tota_allow }})
                                                        </td>
                                                        ...
                                                        @if (\Auth::user()->type != 'Employee')
                                                            <td class="">
                                                                @can('edit other payment')
                                                                    <div class="action-btn bg-primary ms-2">
                                                                        <a href="#"
                                                                            data-url="{{ URL::to('salarytax/' . $salarytax->id . '/edit') }}"
                                                                            data-size="lg" data-ajax-popup="true"
                                                                            title="{{ __('Edit') }}"
                                                                            data-title="{{ __('Edit Salary Tax') }}"
                                                                            class="mx-3 btn btn-sm  align-items-center"
                                                                            data-bs-toggle="tooltip"
                                                                            data-original-title="{{ __('Edit') }}"><i
                                                                                class="ti ti-pencil text-white"></i></a>
                                                                ...
                                                                @can('delete other payment')
                                                                    <div class="action-btn bg-danger ms-2">
                                                                        {!! Form::open([
                                                                            'method' => 'DELETE',
                                                                            'route' => ['salarytax.destroy', $salarytax->id],
                                                                            'id' => 'payment-delete-form-' . $salarytax->id,
                                                                        ]) !!}
                                                                        <a href="#"
                                                                            class="mx-3 btn btn-sm  align-items-center bs-pass-para"
                                                                            data-bs-toggle="tooltip"
                                                                            ...
                                                                            data-original-title="{{ __('Delete') }}"
                                                                            data-confirm="{{ __('Are You Sure?') . '|' . __('This action can not be undone. Do you want to continue?') }}"
                                                                            data-confirm-yes="document.getElementById('payment-delete-form-{{ $salarytax->id }}').submit();"><i
                                                                                class="ti ti-trash text-white"></i></a>
                                                                        {!! Form::close() !!}
                                                                    </div>
                                                                @endcan
                    ...
                    <div class="col-md-6">
                        <div class="card min-height-253">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col">
                                        <h6 class="mb-0">{{ __('EOBI') }}</h6>
                                    </div>
                                    @can('create other payment')
                                        <div class="col text-end">
                                            {{-- NEW: eobi create route --}}
                                            <a href="#" data-url="{{ route('eobi.create', $employee->id) }}"
                                                data-size="lg" data-ajax-popup="true" data-title="{{ __('Create EOBI') }}"
                                                data-bs-toggle="tooltip" title="{{ __('Create') }}"
                                                data-original-title="{{ __('Create EOBI') }}"
                                                class="apply-btn btn btn-sm btn-primary">
                                                <i class="ti ti-plus"></i>
                                            </a>
                                        </div>
                                ...
                                <div class="table-responsive">
                                    @if (!$eobi->isEmpty())
                                        <table class="table table-striped mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($eobi as $item)
                                                    <tr>
                                                        <td>{{ !empty($item->employee()) ? $item->employee()->name : $employee->name }}
                                                        </td>
                                                        <td>{{ $item->title }}</td>
                                                        <td>{{ $item->amount }}</td>
                                                        @if (\Auth::user()->type != 'Employee')
                                                            <td class="">
                                                                @can('edit other payment')
                                                                    <div class="action-btn bg-primary ms-2">
                                                                        <a href="#"
                                                                            data-url="{{ URL::to('eobi/' . $item->id . '/edit') }}"
                                                                            data-size="lg" data-ajax-popup="true"
                                                                            title="{{ __('Edit') }}"
                                                                            data-title="{{ __('Edit EOBI') }}"
                                                                            class="mx-3 btn btn-sm  align-items-center"
                                                                            data-bs-toggle="tooltip"
                                                                ...
                                                                @can('delete other payment')
                                                                    <div class="action-btn bg-danger ms-2">
                                                                        {!! Form::open([
                                                                            'method' => 'DELETE',
                                                                            'route' => ['eobi.destroy', $item->id],
                                                                            'id' => 'eobi-delete-form-' . $item->id,
                                                                        ]) !!}
                                                                        <a href="#"
                                                                            class="mx-3 btn btn-sm align-items-center bs-pass-para"
                                                                            data-bs-toggle="tooltip"
                                                                            ...
                                                                            data-original-title="{{ __('Delete') }}"
                                                                            data-confirm="{{ __('Are You Sure?') . '|' . __('This action can not be undone. Do you want to continue?') }}"
                                                                            data-confirm-yes="document.getElementById('eobi-delete-form-{{ $item->id }}').submit();">
