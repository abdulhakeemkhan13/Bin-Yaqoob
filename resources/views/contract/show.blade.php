        ...
        <div class="col-xl-3">
            <div class="card sticky-top" style="top:30px">
                <div class="list-group list-group-flush" id="useradd-sidenav">
                    ...
                    <a href="#useradd-customer"
                        class="list-group-item list-group-item-action border-0">{{ __('Customer Info') }}
                        <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                    </a>
                    <a href="#useradd-payment"
                        class="list-group-item list-group-item-action border-0">{{ __('Payment Plan') }}
                        <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                    </a>
                    <a href="#useradd-installments"
                        class="list-group-item list-group-item-action border-0">{{ __('Installment Schedule') }}
                        <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                    </a>
        ...
        <div class="col-xl-9">
            <div id="useradd-1">
                <div class="row">
                    ...
                    <div class="col-xxl-6" style="margin-bottom: 25px;">
                        <div class="card report_card total_amount_card h-100">
                            <div class="card-body pt-0" style="margin-bottom: -30px; margin-top: -10px;">
                                <address class="mb-0 text-sm">
                                    <dl class="row mt-4 align-items-center">
                                        ...
                                        <dd class="col-sm-8 text-sm">{{ $contract->subject }}</dd> <br>
                                        ...
                                        <dd class="col-sm-8 text-sm">
                                            {{ !empty($contract->types) ? $contract->types->name : '-' }}</dd><br>
                                        <dt class="col-sm-4 h6 text-sm">{{ __('Status') }}</dt>
                                        <dd class="col-sm-8 text-sm">{{ $contract->status }}</dd><br>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3 col-sm-6">
                                ...
                                <h6 class="mb-0">{{ $contract->project->name ?? '-' }}</h6>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <p class="text-muted text-sm mb-0">{{ __('Tower / Block') }}</p>
                                <h6 class="mb-0">{{ $contract->tower->tower_name ?? '-' }}</h6>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <p class="text-muted text-sm mb-0">{{ __('Floor') }}</p>
                                <h6 class="mb-0">{{ $contract->floor->floor_name ?? '-' }}</h6>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <p class="text-muted text-sm mb-0">{{ __('Unit') }}</p>
                                <h6 class="mb-0">{{ $contract->unit->unit_number ?? '-' }}</h6>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-3 col-sm-6">
                                ...
                                <h6 class="mb-0 text-success">
                                    {{ \Auth::user()->priceFormat($contract->sale_price ?? $contract->value) }}</h6>
                            </div>
                            <div class="col-md-3 col-sm-6">
                        ...
                        @if ($contract->customer)
                            <div class="row">
                                <div class="col-md-3 col-sm-6">
                                    ...
                                    <h6 class="mb-0">{{ $contract->customer->full_name ?? $contract->customer->name }}
                                    </h6>
                                </div>
                                <div class="col-md-3 col-sm-6">
            ...
            <div id="useradd-payment">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">{{ __('Payment Plan') }}</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3 col-sm-6">
                                ...
                                <h6 class="mb-0"><span
                                        class="badge bg-primary">{{ $contract->payment_plan_type ?? 'Installment' }}</span>
                                </h6>
                            </div>
                            @if ($contract->installment_plan)
                                ...
                                <div class="col-md-3 col-sm-6">
                                    ...
                                    <h6 class="mb-0">{{ $contract->installment_plan->installment_count ?? 0 }}</h6>
                                </div>
                                <div class="col-md-3 col-sm-6">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-3 col-sm-6">
                                <p class="text-muted text-sm mb-0">{{ __('Down Payment Due') }}</p>
                                <h6 class="mb-0">
                                    {{ !empty($contract->installment_plan->down_payment_due_date) ? \Auth::user()->dateFormat($contract->installment_plan->down_payment_due_date) : '-' }}
                                </h6>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <p class="text-muted text-sm mb-0">{{ __('Plan Start Date') }}</p>
                                <h6 class="mb-0">
                                    {{ !empty($contract->installment_plan->plan_start_date) ? \Auth::user()->dateFormat($contract->installment_plan->plan_start_date) : '-' }}
                                </h6>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <p class="text-muted text-sm mb-0">{{ __('Frequency') }}</p>
                                <h6 class="mb-0">{{ $contract->installment_plan->installment_frequency ?? 'Monthly' }}
                                </h6>
                            </div>
                            <div class="col-md-3 col-sm-6">
            ...
            <div id="useradd-installments">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">{{ __('Installment Schedule') }}</h5>
                    </div>
                    <div class="card-body">
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    @elseif($installment->status != 'paid')
                                                        <a href="{{ route('invoice.create', ['cid' => $contract->customer_id ?? 0, 'contract_id' => $contract->id, 'installment_id' => $installment->id]) }}"
                                                            ...
                                                            <i class="ti ti-plus"></i> {{ __('Invoice') }}
                                                        </a>
                                                    @endif
                                                </td>
                                            </tr>
                        ...
                        @else
                            <p class="text-muted mb-0">
                                {{ __('No installment schedule available. This contract may use Full Payment or schedule has not been generated.') }}
                            </p>
                        @endif
                    </div>
                </div>
