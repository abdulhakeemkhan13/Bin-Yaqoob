                       ...
                       <div class="card-body pt-0" style="margin-bottom: -30px; margin-top: -10px;">
                           <address class="mb-0 text-sm">
                               <dl class="row mt-4 align-items-center">
                                   ...
                                   <dd class="col-sm-8 text-sm">{{ !empty($contract->projects)?$contract->projects->project_name:'-' }}</dd><br>
                                   <dt class="col-sm-4 h6 text-sm">{{ __('Value') }}</dt>
                                   <dd class="col-sm-8 text-sm"> {{ \Auth::user()->priceFormat($contract->value) }}</dd><br>
                                   <dt class="col-sm-4 h6 text-sm">{{__('Type')}}</dt>
                                   <dd class="col-sm-8 text-sm">{{ !empty($contract->types)?$contract->types->name:'-' }}</dd><br>
                                   ...
                                   <dd class="col-sm-8 text-sm">{{ Auth::user()->dateFormat($contract->start_date) }}</dd><br>
                                   <dt class="col-sm-4 h6 text-sm">{{__('End Date')}}</dt>
                                   <dd class="col-sm-8 text-sm">{{ Auth::user()->dateFormat($contract->end_date) }}</dd><br>
                               </dl>
                           </address>
                       </div>
                   </div>
