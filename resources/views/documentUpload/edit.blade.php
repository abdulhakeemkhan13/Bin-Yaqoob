{{Form::model($ducumentUpload,array('route' => array('document-upload.update', $ducumentUpload->id), 'method' => 'PUT','enctype' => "multipart/form-data", 'data-ajax'=>'true', 'id'=>'document-upload-form')) }}
...
<script>
    $(document).ready(function() {
        $('#document-upload-form').on('submit', function(e) {
            ...
            let form = $(this)[0]; // Get raw DOM form
            let formData = new FormData(form); // Handle file uploads
